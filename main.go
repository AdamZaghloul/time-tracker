...
func main() {
	...
	mux.Handle("DELETE /api/categories", http.HandlerFunc(cfg.handlerDeleteCategory))
	...
	mux.Handle("GET /api/reports/months/{year}/weeks/{month}/days/{week}", http.HandlerFunc(cfg.handlerGetReportDays))
